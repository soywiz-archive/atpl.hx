class DefaultTags {
    static public function checkNoMoreTokens(expressionTokenReader) {
...
//console.log(expressionTokenReader);
    ...
    static public function _flowexception(blockType, templateParser, tokenParserContext, templateTokenReader, expressionTokenReader) {
    ...
    static public function handleOpenedTag(blockType: string, templateParser: TemplateParser.TemplateParser, tokenParserContext: TokenParserContext.TokenParserContext, templateTokenReader: TokenReader, expressionTokenReader: TokenReader, handlers, innerNodeHandler: (node: ParserNode.ParserNode) => void) {
        while (true) {
            try {
...
class ParserNodeAutoescape extends ParserNode.ParserNodeStatement {
	public function new(public expression: ParserNode.ParserNodeExpression, public inner: ParserNode.ParserNode) {
		super();
	}
